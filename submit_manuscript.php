...
<head>
   ...
   <?php
 $page = $functions->getSinglePageData("Submit Manuscript");
echo $meta= $functions->meta_tag($page["meta_title"],$page["meta_desc"],$page["meta_key"],$base_url.'submit_manuscript.php');
 ?>
