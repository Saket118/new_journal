<ul class="nav nav-pills nav-justified mb-2 shadow-sm rounded bg-white" id="article-tabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link small font-weight-bold py-1 w-100 text-truncate active" id="tab-abstract-tab"
...
<div class="tab-content" id="article-tabs-content">
    ...
    <div class="tab-pane fade active show" id="tab-abstract" role="tabpanel" aria-labelledby="tab-abstract-tab">
