...
<button id="scrollToTopBtn"
  class="btn btn-theme position-fixed rounded-circle shadow d-none align-items-center justify-content-center"
...
<footer class="pt-5 journal-footer-base ">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="p-3 contact-details-box border border-dark rounded text-dark d-flex flex-column gap-3 shadow-sm">
                        <div>
                            ...
                            <span class="d-block mb-1">Email: <a href="mailto:editor@japsonline.com"
                                    class="text-dark text-decoration-underline">editor@japsonline.com</a></span>
                            <span class="d-block">Phone: <a href="tel:+918770695689"
                                    class="text-dark text-decoration-underline">+91-8770695689</a></span>
                        </div>
        ...
        <!-- Copyright Strip -->
        <div class="py-3 top-bar-premium">
            <div class="container">
